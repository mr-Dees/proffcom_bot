...
# Логирование событий
import logging
# Доступ к параметрам и функциям операционной системы
import sys
...
# Основные классы для создания телеграмм-бота
...
# Работа с эмбеддингами от HuggingFace
from langchain_community.embeddings import HuggingFaceEmbeddings
# Работа с векторными хранилищами данных
from langchain_community.vectorstores import LanceDB
# Перестановка контекстных фрагментов
from langchain_community.document_transformers import LongContextReorder
# Представление документов
from langchain.docstore.document import Document
# Рекурсивное разбиение текста на части
...
Ты не знаешь что такое теги info и question и не упоминаешь их в своих ответах.
"""
        },
        {
          "role": "user",
          "text": f"""
Прочитай текст в теге info и предоставь один, точный ответ именно на вопрос из тега question и не на что другое.

Если в теге question написано что-то не требующее информации из тега info - не используй его.
Пример таких тем: приветствие, похвала, прощание, благодарность, комплименты, признания, оскорбление, вопросы о личности и возможностях, Smalltalk и тому подобные.  
...
Учти что говорить о информации из тега info и о самом теге info нельзя.
"""
        },
      ]
...
if __name__ == "__main__":
  try:
    ...
    # Если в системе НЕТ созданных ранее эмбеддингов, то создаем их
      ...
      custom_separators = ["\n\n\n\n", "\n\n", "\n", ".", "?", "!", ";", ",", " ", ""]
      splitter = RecursiveCharacterTextSplitter(chunk_size=205, chunk_overlap=0, separators=custom_separators)
